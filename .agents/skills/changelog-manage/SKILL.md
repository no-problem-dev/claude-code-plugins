<!-- AUTO-GENERATED by deploy-to-codex | Source: plugins/release-flow/skills/changelog-manage/SKILL.md | 2026-02-14 -->
---
name: changelog-manage
description: CHANGELOG エントリ追加・バージョン計算。「CHANGELOG」「変更履歴」「changelog add」「version bump」「バージョン」「バージョンアップ」などのキーワードで自動適用。
---
# CHANGELOG・バージョン管理
